...
getIceServers =
  let
    url =
      "https://service.xirsys.com/ice?ident=bsalex&secret=280b50ac-5b50-11e6-8b91-4bca927191f6&domain=display-sync.local.com&application=default&room=default&secure=1"
  in
